<?php /* Smarty version 2.6.20, created on 2016-01-08 14:24:07
    ...
    <div class="panel panel-info" style="margin-top: 150px; ">
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <a href="reporteInventarioGeneral.php" data-toggle="tooltip" data-placement="top" title="Generar PDF" target="_blank"><i class="fa fa-file-pdf-o fa-3x"></i> </a>Generar reporte de inventario general
                </div>
            </div>
